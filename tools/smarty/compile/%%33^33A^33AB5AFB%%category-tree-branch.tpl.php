<?php /* Smarty version 2.6.20, created on 2010-04-24 06:10:46
         compiled from D:%5CHosting%5C4666468%5Chtml%5Cnoithatthaitruc.com/modules/blockcategories/category-tree-branch.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'D:\\Hosting\\4666468\\html\\noithatthaitruc.com/modules/blockcategories/category-tree-branch.tpl', 2, false),array('modifier', 'count', 'D:\\Hosting\\4666468\\html\\noithatthaitruc.com/modules/blockcategories/category-tree-branch.tpl', 3, false),)), $this); ?>
<li <?php if ($this->_tpl_vars['last'] == 'true'): ?>class="last"<?php endif; ?>>
	<a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['node']['link'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" <?php if ($this->_tpl_vars['node']['id'] == $this->_tpl_vars['currentCategoryId']): ?>class="selected"<?php endif; ?> title="<?php echo ((is_array($_tmp=$this->_tpl_vars['node']['desc'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
